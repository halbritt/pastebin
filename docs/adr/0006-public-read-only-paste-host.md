...
This decision was rejected after deployment because the public host read from the private Paste database. ADR 0007 replaces it with separate processes and storage.
